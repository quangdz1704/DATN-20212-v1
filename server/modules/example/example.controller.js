...
exports.createExample = async (req, res) => {
    try {
        ...
        // await Log.info(req.user.email, 'CREATED_NEW_EXAMPLE');
        ...
        // await Log.error(req.user.email, "CREATED_NEW_EXAMPLE");
...
exports.getExamples = async (req, res) => {
    try {
        data = await ExampleService.getExamples(req.query);

        // await Log.info(req.user.email, "GET_ALL_EXAMPLES");
        ...
        console.log(error)
        // await Log.error(req.user.email, "GET_ALL_EXAMPLES");
...
exports.getExampleById = async (req, res) => {
    try {
        ...
        if (example !== -1) {
            // await Log.info(req.user.email, "GET_EXAMPLE_BY_ID");
            res.status(200).json({
                success: true,
        ...
        // await Log.error(req.user.email, "GET_EXAMPLE_BY_ID");
...
exports.editExample = async (req, res) => {
    try {
        ...
        if (updatedExample !== -1) {
            // await Log.info(req.user.email, "UPDATED_EXAMPLE");
            res.status(200).json({
                success: true,
        ...
        // await Log.error(req.user.email, "UPDATED_EXAMPLE");
...
exports.deleteExample = async (req, res) => {
    try {
        ...
        if (deletedExample) {
            // await Log.info(req.user.email, "DELETED_EXAMPLE");
            res.status(200).json({
                success: true,
        ...
        // await Log.error(req.user.email, "DELETED_EXAMPLE");
        res.status(400).json({
            success: false,
...
exports.getOnlyExampleName = async (req, res) => {
    try {
        let data;
        data = await ExampleService.getOnlyExampleName(req.query);

        // await Log.info(req.user.email, "GET_ONLY_NAME_ALL_EXAMPLES");
        res.status(200).json({
            success: true,
        ...
        // await Log.error(req.user.email, "GET_ONLY_NAME_ALL_EXAMPLES");
